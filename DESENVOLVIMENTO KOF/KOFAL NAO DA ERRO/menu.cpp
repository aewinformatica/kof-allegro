...
draw_trans_sprite(Buffer,ARCADE,60,55);
draw_trans_sprite(Buffer,VERSUS,60,55*2);
draw_trans_sprite(Buffer,CPU,60,51*3);
draw_trans_sprite(Buffer,TRANNING,60,51*4);
draw_trans_sprite(Buffer,CONFIG,60,51*5);


draw_trans_sprite(Buffer,DESSEL,50,50);
draw_trans_sprite(Buffer,DESSEL,50,50*2);
draw_trans_sprite(Buffer,DESSEL,50,50*3);
draw_trans_sprite(Buffer,DESSEL,50,50*4);
...
if(pos == 0)
{
 draw_trans_sprite(Buffer,SEL,45,50);      
}
else if(pos == 1)
{
    draw_trans_sprite(Buffer,SEL,45,50*2);
 }
 else if(pos == 2)
{
    draw_trans_sprite(Buffer,SEL,45,50*3);
 }
else if(pos == 3)
{
    draw_trans_sprite(Buffer,SEL,45,50*4);
 }
 else if(pos == 4)
{
    draw_trans_sprite(Buffer,SEL,45,50*5);
 }
