...
void VsMenu::carregar()
{
        ...
        PREVIEW[0] = load_bitmap("imagens/Menu/char/kyo_preview.png",NULL );
        ...
        PREVIEW[8] = load_bitmap("imagens/Menu/char/kyo_preview.png",NULL );
        PREVIEW[9] = load_bitmap("imagens/Menu/char/kyo_preview.png",NULL );
...
draw_trans_sprite(Buffer,PREVIEW[pos],0,60);
if(key[KEY_ENTER])
{
  ...
  else if(pos == 9)
{
 ...
 draw_trans_sprite(Buffer,BARRABG,0,400);
 }
